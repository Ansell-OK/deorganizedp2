                ...
                <div className="relative rounded-3xl overflow-hidden bg-canvas border border-borderSubtle shadow-soft">
                    ...
                    <div className="relative z-10 grid lg:grid-cols-2 gap-8 p-8 md:p-12">
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Co-Hosts Section */}
                            {show.co_hosts && show.co_hosts.length > 0 && (
                                <div className="bg-surface px-4 py-3 rounded-xl border border-borderSubtle">
                                    <h3 className="text-sm font-bold text-ink mb-2 flex items-center gap-2">
                                        <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M5 16L3 5l5.5 5L12 4l3.5 6L21 5l-2 11H5zm14 3c0 .6-.4 1-1 1H6c-.6 0-1-.4-1-1v-1h14v1z" />
                                        </svg>
                                        Co-Hosts ({show.co_hosts.length})
                                    </h3>
                                    <div className="flex flex-wrap gap-3">
                                        {show.co_hosts.map((coHost) => (
                                            <div
                                                key={coHost.id}
                                                className="flex items-center gap-2 bg-gold/10 border border-gold/30 px-3 py-2 rounded-full hover:bg-gold/20 transition-all cursor-pointer"
                                                onClick={() => onNavigate?.('creator-detail', coHost.id)}
                                            >
                                                <img
                                                    ...
                                                    className="w-6 h-6 rounded-full object-cover"
                                                />
                                                <span className="text-sm font-semibold text-ink">{coHost.username}</span>
                                                {coHost.is_verified && (
                                                    <svg className="w-4 h-4 text-gold" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                                    </svg>
